<!DOCTYPE html>
<html lang="en">
<head><title>ResoExpo | Gallery</title>
    <meta charset="utf-8">
            ...
            <div class="content">
                ...
                <div class="section gallery-content">
                    <div class="container margin-top">
                        <div class="gallery-nav"><a role="button" data-toggle="collapse" href="#filters" aria-expanded="false" aria-controls="filters" class="btn btn-primary hidden-lg hidden-md hidden-sm"><span>All</span><i class="fa fa-angle-down"></i></a>
                        </div>
                        <div class="grid">
                            <div class="row">
                                    ...
                                    ?>
                                        <div class="col-md-4 col-xs-6">
                                            <div class="sunhouse-item"><a href="property-detail.php" class="wrapper-image"><img src="img/<?php echo $data['2']; ?>" alt="" class="img-responsive layout-1"/><img src="img/<?php echo $data['2']; ?>" alt="" class="img-responsive layout-2"/></a>
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="col-md-4">
                                                ...
                                                <div class="icon-wrapper"><img src="img/<?php echo $data['2']; ?>" class=" img-responsive" width="360px" height="250px"></i></div>
